  ...
  return (
    <>
      <div className="mx-auto mt-16 max-w-5xl space-y-20 px-4 text-foreground sm:px-6">
        {/* Hero headline directly below the setup tool */}
      ...
      <footer className="relative mt-16 bg-background text-foreground/90">
        ...
        <div className="mx-auto max-w-6xl px-6 pt-10 pb-14 text-center text-sm text-muted-foreground">
...
export function DefaultHomepageTemplate() {
  return (
    <HomepageTemplate
      ...
      heroDescription="Use this space for a concise description of the product value. Keep copy short and scannable so teams can swap in their own language."
      ...
      stepsHeading="How to Use This Timer"
      steps={[
        {
          label: "Step 1",
      ...
      useCasesTagline="Built for Every Routine"
      useCasesHeading="Timer Perfect for Every Routine"
      useCasesDescription="Swap in the top categories that matter for your product. Keep the list balanced and scannable."
      useCases={[
      ...
      faqHeading="FAQ of Example Timer"
      faqs={[
        {
      ...
      ctaHeading="Start Your Session"
      ctaDescription="Invite visitors to launch the timer or feature immediately. Keep copy imperative and energetic."
      ctaLabel="Open Timer"
    />
  );
}
